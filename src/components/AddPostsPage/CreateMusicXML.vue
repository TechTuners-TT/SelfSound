<template>
  ...
  <div class="relative flex items-start justify-center w-full h-full">
    ...
    <div
      class="relative flex w-full md:w-3/5 xl:w-1/3 bg-black/30 flex flex-col min-h-screen overflow-y-auto"
    >
      <!-- Section 1 -->
      <section>
        <TitleSection />
...
import AttachMediaXML from "./sections/CreateMusicXML/AttachMusicXML.vue";
</script>

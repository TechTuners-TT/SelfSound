<template>
  <div
    v-if="isOpen"
    class="fixed top-0 left-0 z-50 w-full h-full flex justify-start items-center [@media(min-width:1537px)]:ml-25 xl:ml-[70px] lg:ml-[60px] md:ml-[60px] sm:ml-[0px] max-md:justify-center max-md:items-end"
    @click.self="close"
  >
    <div
